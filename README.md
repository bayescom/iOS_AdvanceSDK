...
target '你的项目名称' do
  ...
  # Pods for 你的项目名称
<<<<<<< HEAD
  pod 'AdvanceSDK', '~> 3.2.3.1' # 可指定你想要的版本号
=======
  pod 'AdvanceSDK', '~> 3.2.2.9' # 可指定你想要的版本号
...
<<<<<<< HEAD
  pod 'AdvanceSDK', '~> 3.2.3.1' # 可指定你想要的版本号
  pod 'AdvanceSDK/CSJ', '~> 3.2.3.1'	# 如果需要导入穿山甲SDK
  pod 'AdvanceSDK/GDT', '~> 3.2.3.1'	# 如果需要导入广点通SDK
=======
  pod 'AdvanceSDK', '~> 3.2.2.9' # 可指定你想要的版本号
  pod 'AdvanceSDK/CSJ', '~> 3.2.2.9'	# 如果需要导入穿山甲SDK
  pod 'AdvanceSDK/GDT', '~> 3.2.2.9'	# 如果需要导入广点通SDK
>>>>>>> 0124cdfaf9aac7d872f258f5b86800836d235275
