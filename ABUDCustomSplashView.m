...
@interface ABUDCustomSplashView ()
...
@implementation ABUDCustomSplashView

+ (instancetype)splashViewWithSize:(CGSize)size rootViewController:(nonnull UIViewController *)rootViewController {
    ABUDCustomSplashView *view = [[ABUDCustomSplashView alloc] initWithFrame:(CGRect){CGPointZero, size}];
    [view setupView];
