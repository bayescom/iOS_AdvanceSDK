...
- (void)viewDidLoad {
    ...
    self.adspotIdsArr = @[
        ...
        @{@"addesc": @"自渲染-穿山甲", @"adspotId": @"102768-10008353"},
        ...
        @{@"addesc": @"自渲染-Tanx", @"adspotId": @"102768-10009464"},
        @{@"addesc": @"自渲染-Sigmob", @"adspotId": @"102768-10011991"},
        @{@"addesc": @"自渲染-Funlink", @"adspotId": @"102768-10014892"},
        @{@"addesc": @"自渲染-汇川", @"adspotId": @"102768-10015621"}
    ];
    self.btn1Title = @"展示广告";
}
