...
- (void)loadAd {
    ...
    [self.tanx_ad getFeedAdsWithAdCount:1 renderMode:TXAdFeedRenderModeTemplate adsBlock:^(NSArray<TXAdModel *> * _Nullable viewModelArray, NSError * _Nullable error) {
        if (error) { // 获取广告失败
